...
def load_mesh(stl_path: str) -> o3d.geometry.PointCloud:
    ...
    try:
        ...
        logger.info(f"Recovered {len(points)} unique points")
        return pcd
...
def compute_advanced_metrics(
    ...
    return {
        ...
        'normal_angles': np.rad2deg(normal_angles)
    }
...
def validate_3dm_file(file_path: str) -> bool:
    ...
    try:
        ...
        logger.error(f"Invalid .3dm file: {str(e)}")
        return False

def validate_stl_file(file_path: str) -> bool:
    ...
    try:
        ...
        logger.error(f"STL Error: {str(e)}")
        return False
